...
/**
 * Centralised REST exception handling for auth-service.
 *
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> rateLimited(RateLimitExceededException ex, HttpServletRequest req) {
        return ResponseEntity.status(HttpStatus.TOO_MANY_REQUESTS).body(ErrorResponse.withRule(
