...
/**
 * Stateless security for auth-service.
 *
 ...
 * method-level {@code @PreAuthorize} rules (e.g. ADMIN-only registration/user management)
 * are enforced here. Login and password-reset endpoints stay public.</p>
 */
@Configuration
@EnableWebSecurity
