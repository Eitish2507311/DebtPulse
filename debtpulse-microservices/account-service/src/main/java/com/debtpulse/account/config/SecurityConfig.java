...
/**
 * Stateless security for account-service.
 *
 ...
 * {@code @PreAuthorize} rules are enforced here. Only docs/actuator are public; everything
 * else (including {@code /api/internal/**} reached over Feign) requires authentication.</p>
 */
@Configuration
@EnableWebSecurity
