...
import { inr, num, pct, dateTime } from '../../utils/format.js';
...
export default function AnalyticsPage() {
  ...
  const reports = usePaged(reportsFetcher, { size: 10 });
  ...
  return (
    <>
      ...
      <DataTable columns={reportCols} page={reports.page} loading={reports.loading} onPageChange={reports.setPage}
