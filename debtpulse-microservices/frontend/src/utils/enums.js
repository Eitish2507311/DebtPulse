...
export const ENUMS = {
  ...
  AccountStatus: ['ACTIVE', 'SETTLED', 'RESTRUCTURED', 'LEGAL', 'WRITEOFF', 'CLOSED'],
...
const AMBER = ['PENDING_APPROVAL', 'PARTIAL', 'RESCHEDULED', 'PENDING', 'HEARING_SCHEDULED', 'SCHEDULED', 'UNVERIFIED', 'ISSUED', 'IN_EXECUTION', 'DRAFT', 'ADJOURNED', 'PARTIALLY_HEARD', 'BORROWER_ABSENT', 'BUSY_TONE', 'NOT_CONNECTED', 'FILED', 'RESTRUCTURED'];
