...
import { ACCESS, ROLE_LABELS, hasAny } from '../auth/roles';
    ...
    <div className="app-shell">
      <aside className={`sidebar ${open ? 'open' : ''}`}>
        ...
        <div className="side-foot">
          Signed in as<br /><span className="text-white">{role ? ROLE_LABELS[role] : ''}</span>
        </div>
      </aside>
      ...
      <div className="main-wrap">
        <header className="topbar">
          ...
          <button className="btn btn-sm position-relative me-1" title="Notifications" onClick={() => navigate('/notifications')}>
          ...
          <Dropdown align="end">
            <Dropdown.Toggle variant="light" size="sm" className="d-flex align-items-center gap-2 border-0">
              ...
              <span className="d-none d-md-inline text-start">
                ...
                <small className="text-muted">{role ? ROLE_LABELS[role] : ''}</small>
              </span>
            </Dropdown.Toggle>
            <Dropdown.Menu>
              <Dropdown.Header>
              ...
              <Dropdown.Item onClick={() => navigate('/change-password')}><i className="bi bi-key me-2" />Change password</Dropdown.Item>
              <Dropdown.Divider />
